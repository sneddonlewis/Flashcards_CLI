...
public class FileManager {
    public static List<flashcards.model.Card> loadFromFile(String filename) throws IOException {
        try (var fileInput = new FileInputStream(filename);
             var ois = new ObjectInputStream(fileInput);
        ) {
            return (List<flashcards.model.Card>) ois.readObject();
    ...
    public static void saveToFile(String filename, List<flashcards.model.Card> data) {
